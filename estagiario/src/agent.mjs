...
const TOOLS = [
  ...
  { type: "function", function: { name: "dados_condominio", description: "Dados cadastrais do condomínio AO VIVO do Superlógica: nome, endereço, CEP, cidade/UF e CNPJ. Use quando a equipe perguntar o endereço ou o CNPJ de um condomínio. NÃO traz o nome do síndico (esse é um cadastro à parte, ainda não ligado) — se pedirem o síndico, diga que ainda não está disponível por aqui; nunca invente CNPJ/endereço.", parameters: { type: "object", properties: { condominio: { type: "string", description: "Nome/slug do condomínio." } }, required: ["condominio"] } } },
