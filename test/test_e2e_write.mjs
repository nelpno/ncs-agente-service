...
const r = await runToolReal('criar_rascunho_cadastro', { id_condominio: '181', id_unidade: '900', nome: 'Maria Teste', data_entrada: '10/06/2026', cpf: '52998224725', email: 'maria@x.com', telefone: '16999990000' }, ctx);
