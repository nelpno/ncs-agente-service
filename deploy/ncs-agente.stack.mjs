...
export const ANA_IMAGE = "ghcr.io/nelpno/ncs-agente-service@sha256:d745f0a1ac880cb540e15b10405d19115081813b3f887a1a6a06621f9df20c90"; // e4333e5: respostas do Fernando de 04/08. (1) CITACOES: as 8 decisoes dele aplicadas verbatim (lume reformas c+d, park roupas d, moove ar-condicionado g e danos b, vancouver fumar s e lixo v, atlanta seguranca Art.16 §1, spazio-abbocato vaga k) e registradas em gerador/decisoes/ para sobreviver a uma re-extracao, que as apagaria em silencio (guard test_decisoes_citacao no gate). Bug pego no caminho: a letra "v" (e "i", "x") era classificada como numeral romano, entao o corte procurava o proximo item ROMANO e o item v) do Vancouver engolia o w) e os PARAGRAFOS seguintes (1218c em vez de 153c) - uma letra sozinha e sempre letra. Paineiras NAO aplicado de proposito: a Convencao ingerida esta com o texto embaralhado no Artigo 10 (OCR da origem) e cortar pioraria o documento. (2) CATALOGOS: sevilha, mario-de-andrade e vitta-ipe-roxo pela Convencao (decisao dele: seguem a minuta, nunca aprovaram R.I.) -> 55/55 condominios geram multa e notificacao, verificar-catalogo 55/55 APROVADO. (3) TOOL NOVA consultar_carteira_ncs: responde "voces administram o condominio X?". Medido nas conversas: 54 em 30 dias tocaram no tema e a Ana nao confirmava nem o Edificio Residencial Park nem o L Harmonie, que SAO da carteira - boa parte de quem pergunta esta comprando apartamento ou e imobiliaria. Base data/carteira SEM PII (so o nome, gerada por .tmp/gen_carteira.py); reusa _filtrarCondos, o mesmo matcher da identificacao de unidade. Nao achar NUNCA vira negativa categorica (pode ser outra grafia ou cliente novo). Suite 99+28 verde. DRY_RUN mantido; Frente C DORMANTE
