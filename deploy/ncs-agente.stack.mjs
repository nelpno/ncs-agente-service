...
export const ANA_IMAGE = "ghcr.io/nelpno/ncs-agente-service@sha256:6f5a3af47477aa5b1a520ee257d305d1663990db821d3b824d5a94f14623e5c6"; // d373504: a Ana passa a CONFIRMAR se uma cobranca recebida e oficial (tool verificar_cobranca_oficial, src/cobrador.mjs). Conv 693 (06/08, Vida Plena): o morador recebeu WhatsApp de "Vitoria (16) 3214-5117" cobrando e perguntou se era golpe; a Ana disse que nao conseguia validar. O numero e do CHAGAS & OLIVEIRA, que a planilha lista como responsavel daquele condominio. Estava travado porque, no mesmo dia, um atendente disse ao morador que o escritorio "nao tem vinculo com a administradora". O Fernando resolveu em 07/08: o escritorio e contratado PELO CONDOMINIO, nao pela NCS - as duas frases eram verdade. TRAVAS: (1) ela CONFIRMA o que e oficial e NUNCA acusa de golpe (acusar um escritorio real de fraude e acusacao contra terceiro, e ela nao tem como saber); nao bateu = humano da carteira + "nao faca nenhum pagamento". (2) A tool fala com MORADOR e NUNCA devolve juros/multa/honorarios/parcelamento - isso segue so no Estagiario. "Dr" e palavra estrutural (sozinha casaria 3 escritorios). Junto: planilha de cobranca de 07/08 (3 CNPJs corrigidos, Angelo Smirne liberado 1%/2%/10% 2x, Atlanta a vista; Magnolias I e Royal Garden I ja eram "passa direto para equipe"; SEIVA fora da base de proposito). 35 testes novos, suite 102/0. DRY_RUN mantido. Anterior 019367e: os TRES buracos medidos no uso real de 06/08, cada um visto numa conversa de morador. (1) BOLETO DE UM MES: conv 658 (Allure Bl13/401) precisava o de julho p/ abrir sinistro e a equipe mandou a mao. Sondado ao vivo: o cobranca/index SEM data devolve so o mes CORRENTE, nem com status=todos; com filtrarpor=vencimento+dtInicio/dtFim alcanca qualquer mes (julho=717 itens, 309 pagos, link em 717/717). filtrarpor=competencia MISTURA meses -> a regua e o VENCIMENTO. Boleto PAGO sai como DOCUMENTO e NUNCA com PIX (pediria o comprovante e receberia codigo de pagamento); em aberto +30d segue indo a cobranca. (2) TAXA EXTRA DO FLORES: conv 685, a Ana mandou tudo p/ a CONDINVEST e o atendente entregou em seguida o boleto da taxa extra do apto 624 - a moradora ouviu "nao e conosco" sobre algo que e. Correcao de DADO (nota_extra no CONDOMINIO, nao na garantidora, que atende 3 predios); quem nao tem a nota responde igual a antes. (3) QUAIS MESES estao em aberto: a Ana sabia a quantidade e nao os itens. NUNCA existe total_a_pagar - os valores da API sao os originais, sem juros/multa/honorarios, e um numero dito como "e isso que voce deve" sairia MENOR que o real. Unidade em processo JUDICIAL nao recebe a relacao (mesma regra que ja bloqueia a 2a via) - risco achado pelo smoke ao vivo, numa unidade com 56 cobrancas desde 2024. 78 testes novos + smoke AO VIVO contra a API real, com a nao-regressao provada (sem 'mes' o retorno e identico ao anterior). Suite 101/0. DRY_RUN mantido. Leva junto 375b156/0052ea4/4995733 (parametros de cobranca, _filtrarCondos, PII das atas), que ja estavam no Estagiario. Anterior 017dd53: a pagina de aprovacao por LINK passa a avisar que esta em MODO TESTE. Em 05/08 o Fernando abriu o card de um cadastro real (contrato de locacao lido pelo DocIA), aprovou, e leu so "gravado" — com DRY_RUN_WRITES=true nada foi para o Superlogica; ele descobriu depois ("agora vi que vai para uma simulacao"). O portal do Estagiario ja tinha banner; a pagina por token, nao. A condicao vem de vaiSimular() em superlogica_write.mjs, a MESMA do slPut — banner com regra propria mente no dia em que uma das duas mudar. O desfecho pos-clique tambem deixou de ser "gravado (simulacao)" em letra miuda. Guard: test/test_painel_simulacao.mjs. Suite 127/0 (rodada DENTRO da imagem: o run do Actions foi CANCELADO na fila e o gate nao rodou la). DRY_RUN mantido. Anterior e6a19c0: decisoes do Fernando de 04/08 sobre a carteira. (1) Condominio FORA da lista: a Ana pergunta o nome completo UMA vez e, se nao bater, diz que nao consta e ENCERRA - sem insistir e sem prometer retorno ("Se imobiliaria ou morador falar condominio nao da lista... Pode encerrar"). Antes a orientacao era NUNCA encerrar, por medo de perder cliente com grafia diferente. 🔑 So e seguro PORQUE o lead tem destino: a EXCECAO comercial esta explicita no retorno da tool - quem fala em orcamento/proposta/contratar NAO e encerrado, vai para o Fernando (roteamento no adapter, ehLeadComercial + FERNANDO_USER_ID=3). Mexer numa das duas regras exige conferir a outra. Traz junto d394628: o nome OFICIAL do condominio passa a resolver o catalogo (39 de 58 nao casavam; o nome do ERP entrou como alias em 37 catalogos, pino 0 degradadas) e "Rosas de Ouro" resolve. E 2afdd48: guard que RECUSA gerar multa com texto_artigo vazio. Suite 126/0. DRY_RUN mantido
